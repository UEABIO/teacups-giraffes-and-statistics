...
mclapply(1:3, function(x) ppplot(x), mc.cores = 1, mc.cleanup = TRUE)
...
mclapply(seq(1,300, 20), function(x) plots3(x), mc.cores = 1, mc.cleanup = TRUE)
...
mclapply(seq(301,960, 20), function(x) plots3.2(x), mc.cores = 1, mc.cleanup = TRUE)
...
mclapply(rep(960, 40), function(x) plots4(x), mc.cores = 1, mc.cleanup = TRUE)
```
</center>
...
<iframe class="interactive" id="myIframe1" src="https://biouea.shinyapps.io/06-standardError-ex1/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe2" src="https://biouea.shinyapps.io/06-standardError-ex2/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe3" src="https://biouea.shinyapps.io/06-standardError-ex3/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe4" src="https://biouea.shinyapps.io/06-standardError-ex4/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe5" src="https://biouea.shinyapps.io/06-standardError-ex5/" scrolling="no" frameborder="no"></iframe>
