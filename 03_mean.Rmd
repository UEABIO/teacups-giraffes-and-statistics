...
<iframe class="interactive" id="myIframe1" src="https://biouea.shinyapps.io/03-mean-ex1/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe2" src="https://biouea.shinyapps.io/03-mean-ex2/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe3" src="https://biouea.shinyapps.io/03-mean-ex3/" scrolling="no" frameborder="no"></iframe>
...
<iframe class="interactive" id="myIframe4" src="https://biouea.shinyapps.io/03-mean-ex4b/" scrolling="no" frameborder="no"></iframe>
...
```{r, tut=FALSE, echo=FALSE, message= FALSE, cache=TRUE, eval=FALSE}
library(emdbook)
library(plotly)
library(here)
